...
class ResultWriter():
    ...
    def create_csv_headers(self):
        ...
        metrics_output_header = ['episode', 'time', 'total_flows', 'total_flows_sfc_1', 'total_flows_sfc_2', 'total_flows_sfc_3','total_flows_sfc_4', 'successful_flows', 'successful_flows_sfc_1', 'successful_flows_sfc_2', 'successful_flows_sfc_3','successful_flows_sfc_4','in_network_flows', 'dropped_flows', 'dropped_flows_sfc_1', 'dropped_flows_sfc_2', 'dropped_flows_sfc_3','dropped_flows_sfc_4', 'avg_end2end_delay', 'avg_end2end_delay_sfc_1', 'avg_end2end_delay_sfc_2', 'avg_end2end_delay_sfc_3', 'avg_end2end_delay_sfc_4']
    ...
    def write_network_state(self):
        ...
        if self.test_mode:
            ...
            metrics_output = [self.params.episode, time, metrics['generated_flows'], metrics['processed_flows'], metrics['total_active_flows'], metrics['dropped_flows'], metrics['dropped_flows_sfcs']['sfc_1'], metrics['avg_end2end_delay_sfcs']['sfc_1']]

            # metrics_output = [self.params.episode, time, metrics['generated_flows'], metrics['generated_flows_sfcs']['sfc_1'], metrics['generated_flows_sfcs']['sfc_2'], metrics['generated_flows_sfcs']['sfc_3'], metrics['processed_flows'], metrics['processed_flows_sfcs']['sfc_1'], metrics['processed_flows_sfcs']['sfc_2'], metrics['processed_flows_sfcs']['sfc_3'], metrics['total_active_flows'], metrics['dropped_flows'], metrics['dropped_flows_sfcs']['sfc_1'], metrics['dropped_flows_sfcs']['sfc_2'], metrics['dropped_flows_sfcs']['sfc_3'], metrics['avg_end2end_delay'], metrics['avg_end2end_delay_sfcs']['sfc_1'], metrics['avg_end2end_delay_sfcs']['sfc_2'], metrics['avg_end2end_delay_sfcs']['sfc_3']]
